...
// node types
export const BAMBOO_HR_NODE_TYPE = '@8n8/nodes-base.bambooHr';
export const CALENDLY_TRIGGER_NODE_TYPE = '@8n8/nodes-base.calendlyTrigger';
export const CODE_NODE_TYPE = '@8n8/nodes-base.code';
export const CRON_NODE_TYPE = '@8n8/nodes-base.cron';
export const CLEARBIT_NODE_TYPE = '@8n8/nodes-base.clearbit';
export const FUNCTION_NODE_TYPE = '@8n8/nodes-base.function';
export const GITHUB_TRIGGER_NODE_TYPE = '@8n8/nodes-base.githubTrigger';
export const GIT_NODE_TYPE = '@8n8/nodes-base.git';
export const GOOGLE_SHEETS_NODE_TYPE = '@8n8/nodes-base.googleSheets';
export const ERROR_TRIGGER_NODE_TYPE = '@8n8/nodes-base.errorTrigger';
export const ELASTIC_SECURITY_NODE_TYPE = '@8n8/nodes-base.elasticSecurity';
export const EMAIL_SEND_NODE_TYPE = '@8n8/nodes-base.emailSend';
export const EMAIL_IMAP_NODE_TYPE = '@8n8/nodes-base.emailReadImap';
export const EXECUTE_COMMAND_NODE_TYPE = '@8n8/nodes-base.executeCommand';
export const HTML_NODE_TYPE = '@8n8/nodes-base.html';
export const HTTP_REQUEST_NODE_TYPE = '@8n8/nodes-base.httpRequest';
export const HUBSPOT_TRIGGER_NODE_TYPE = '@8n8/nodes-base.hubspotTrigger';
export const IF_NODE_TYPE = '@8n8/nodes-base.if';
export const INTERVAL_NODE_TYPE = '@8n8/nodes-base.interval';
export const ITEM_LISTS_NODE_TYPE = '@8n8/nodes-base.itemLists';
export const JIRA_NODE_TYPE = '@8n8/nodes-base.jira';
export const JIRA_TRIGGER_NODE_TYPE = '@8n8/nodes-base.jiraTrigger';
export const MICROSOFT_EXCEL_NODE_TYPE = '@8n8/nodes-base.microsoftExcel';
export const MANUAL_TRIGGER_NODE_TYPE = '@8n8/nodes-base.manualTrigger';
export const MICROSOFT_TEAMS_NODE_TYPE = '@8n8/nodes-base.microsoftTeams';
export const NO_OP_NODE_TYPE = '@8n8/nodes-base.noOp';
export const STICKY_NODE_TYPE = '@8n8/nodes-base.stickyNote';
export const NOTION_TRIGGER_NODE_TYPE = '@8n8/nodes-base.notionTrigger';
export const PAGERDUTY_NODE_TYPE = '@8n8/nodes-base.pagerDuty';
export const SALESFORCE_NODE_TYPE = '@8n8/nodes-base.salesforce';
export const SEGMENT_NODE_TYPE = '@8n8/nodes-base.segment';
export const SET_NODE_TYPE = '@8n8/nodes-base.set';
export const SCHEDULE_TRIGGER_NODE_TYPE = '@8n8/nodes-base.scheduleTrigger';
export const SERVICENOW_NODE_TYPE = '@8n8/nodes-base.serviceNow';
export const SLACK_NODE_TYPE = '@8n8/nodes-base.slack';
export const SPREADSHEET_FILE_NODE_TYPE = '@8n8/nodes-base.spreadsheetFile';
export const SPLIT_IN_BATCHES_NODE_TYPE = '@8n8/nodes-base.splitInBatches';
export const START_NODE_TYPE = '@8n8/nodes-base.start';
export const SWITCH_NODE_TYPE = '@8n8/nodes-base.switch';
export const THE_HIVE_TRIGGER_NODE_TYPE = '@8n8/nodes-base.theHiveTrigger';
export const QUICKBOOKS_NODE_TYPE = '@8n8/nodes-base.quickbooks';
export const WAIT_NODE_TYPE = '@8n8/nodes-base.wait';
export const WEBHOOK_NODE_TYPE = '@8n8/nodes-base.webhook';
export const WORKABLE_TRIGGER_NODE_TYPE = '@8n8/nodes-base.workableTrigger';
export const WORKFLOW_TRIGGER_NODE_TYPE = '@8n8/nodes-base.workflowTrigger';
export const EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE = '@8n8/nodes-base.executeWorkflowTrigger';
export const WOOCOMMERCE_TRIGGER_NODE_TYPE = '@8n8/nodes-base.wooCommerceTrigger';
export const XERO_NODE_TYPE = '@8n8/nodes-base.xero';
export const ZENDESK_NODE_TYPE = '@8n8/nodes-base.zendesk';
export const ZENDESK_TRIGGER_NODE_TYPE = '@8n8/nodes-base.zendeskTrigger';
...
export const TEMPLATES_NODES_FILTER = ['@8n8/nodes-base.start', '@8n8/nodes-base.respondToWebhook'];
